...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.server_message_text = QtWidgets.QLineEdit(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.server_message_text.setFont(font)
        self.server_message_text.setFocusPolicy(QtCore.Qt.ClickFocus)
        self.server_message_text.setInputMask("")
        self.server_message_text.setText("")
        self.server_message_text.setObjectName("server_message_text")
        self.verticalLayout_2.addWidget(self.server_message_text)
        ...
        self.client_message_text = QtWidgets.QLabel(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.client_message_text.setFont(font)
        self.client_message_text.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.client_message_text.setObjectName("client_message_text")
        self.horizontalLayout_4.addWidget(self.client_message_text)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.server_message_text.setPlaceholderText(_translate("MainWindow", "Enter Your Message"))
        self.label_2.setText(_translate("MainWindow", "From Client:"))
        self.client_message_text.setText(_translate("MainWindow", "Null"))
        self.title_label.setText(_translate("MainWindow", "Server App"))
        ...
        self.start_btn.setText(_translate("MainWindow", "Start Server"))
